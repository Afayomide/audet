    ...
    <nav>
      <div className="mobile-nav">
        <div className="mobile-header-container">
          ...
          <div>
            {!showNav ? (
              <FaHamburger onClick={HandleShowNav} />
            ) : (
              <FaX onClick={HandleShowNav} />
            )}
          </div>
        </div>
          ...
          <div className="mobile-nav-links-container">
            <Link
              className={`mobile-nav-link ${
                pathname === "/genres" && query === "pop" ? "active" : ""
              }`}
              href="/genres?=pop"
            >
              Pop
            ...
            <Link
              className={`mobile-nav-link ${
                pathname === "/genres" && query === "afrobeat" ? "active" : ""
              }`}
              href="/genres?=afrobeat"
            >
              Afrobeats
            </Link>
            {/* <Link
            ...
            {!isAuthenticated ? (
              ...
              <div>
                <button onClick={logout} className="mobile-nav-logout">
                  Logout
                </button>
              </div>
            )}
